...
import TeacherBoxes from './TeacherBoxes'
...
function Layout(props) {
    ...
    const drawer = (
        ...
        <Box sx={{width:"100%",display:"flex",alignItems:"center",flexDirection:"column",paddingTop:"20px"}}>
            <Avatar src={`${process.env.REACT_APP_API}/images/${currentTeacher.teacher.image}`}
            sx={{marginBottom:"10px",width:"115px",height:"115px",fontSize:"42px"}} alt={currentTeacher.teacher.name}/>
            <Text>مرحبا بك ..</Text>
            <Text>الأستاذ / {currentTeacher.teacher.name}</Text>
        </Box>
        <List>
            <Image/>
