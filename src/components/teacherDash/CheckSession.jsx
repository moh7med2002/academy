...
export default function CheckSession({setOpenCheck,filterSessions,id,token}) {
    ...
    async function acceptSession()
    {
        ...
        setOpenCheck(false)
        try{
            const response = await fetch(`${process.env.REACT_APP_API}/api/psycho/teacher/accept`,{
                method:"PUT",
                headers:{
                    "Authorization":token,
